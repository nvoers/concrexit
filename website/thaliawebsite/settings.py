...
MONEYBIRD_CONTRIBUTION_TAX_RATE_ID: Optional[int] = (
    int(os.environ.get("MONEYBIRD_CONTRIBUTION_TAX_RATE_ID"))
    if os.environ.get("MONEYBIRD_CONTRIBUTION_TAX_RATE_ID")
    else None
)
